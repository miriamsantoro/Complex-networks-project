...
saveas(gcf, 'radiomics_76/glcm_1.png');
...
saveas(gcf, 'radiomics_76/glcm_2.png');
...
saveas(gcf, 'radiomics_76/glcm_3.png');
...
filename=('radiomics_76/hp_glcm.mat');
...
xlabel('Image orientation');
ylabel('RLN value');
saveas(gcf, 'radiomics_76/glrlm_1.png');
...
xlabel('Image orientation');
ylabel('SRHGE value');
saveas(gcf, 'radiomics_76/glrlm_2.png');
...
xlabel('Image orientation');
ylabel('RLV value');
saveas(gcf, 'radiomics_76/glrlm_3.png');
...
filename=('radiomics_76/hp_glrlm.mat');
...
xlabel('Image orientation');
ylabel('ZSN value');
saveas(gcf, 'radiomics_76/glszm_1.png');
...
xlabel('Image orientation');
ylabel('SZLGE value');
saveas(gcf, 'radiomics_76/glszm_2.png');
...
xlabel('Image orientation');
ylabel('ZSV value');
saveas(gcf, 'radiomics_76/glszm_3.png');
...
filename=('radiomics_76/hp_glszm.mat');
...
saveas(gcf, 'radiomics_76/ngtdm_1.png');
...
saveas(gcf, 'radiomics_76/ngtdm_2.png');
...
filename=('radiomics_76/hp_ngtdm.mat');
...
filename=('radiomics_76/hp_g.mat');
