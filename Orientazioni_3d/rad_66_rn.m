...
%% Create mask (volumetric mask red nucleus roi 66)
img=imread('im1_66.png');
h_im=imshow(img(51:115, 61:125));
e = imellipse(gca, [21.6908783783784 23.4476351351351 7.90540540540539 7.68581081081082]);
...
saveas(gcf, 'radiomics_66/rn/glcm_1.png');
...
saveas(gcf, 'radiomics_66/rn/glcm_2.png');
...
saveas(gcf, 'radiomics_66/rn/glcm_3.png');
...
filename=('radiomics_66/rn/hp_glcm.mat');
...
xlabel('Image orientation');
ylabel('RLN value');
saveas(gcf, 'radiomics_66/rn/glrlm_1.png');
...
xlabel('Image orientation');
ylabel('SRHGE value');
saveas(gcf, 'radiomics_66/rn/glrlm_2.png');
...
xlabel('Image orientation');
ylabel('RLV value');
saveas(gcf, 'radiomics_66/rn/glrlm_3.png');
...
filename=('radiomics_66/rn/hp_glrlm.mat');
...
xlabel('Image orientation');
ylabel('ZSN value');
saveas(gcf, 'radiomics_66/rn/glszm_1.png');
...
xlabel('Image orientation');
ylabel('SZLGE value');
saveas(gcf, 'radiomics_66/rn/glszm_2.png');
...
xlabel('Image orientation');
ylabel('ZSV value');
saveas(gcf, 'radiomics_66/rn/glszm_3.png');
...
filename=('radiomics_66/rn/hp_glszm.mat');
...
saveas(gcf, 'radiomics_66/rn/ngtdm_1.png');
...
saveas(gcf, 'radiomics_66/rn/ngtdm_2.png');
...
filename=('radiomics_66/rn/hp_ngtdm.mat');
...
saveas(gcf, 'radiomics_66/rn/g.png');
...
filename=('radiomics_66/rn/hp_g.mat');
save(filename,'h_g','p_g')

%%
t_rn=zeros(12,36);
for i=1:12
    t_rn(i,:)=[glcm_ene(i),glcm_con(i),glcm_ent(i),glcm_hom(i),glcm_cor(i),glcm_sa(i),glcm_var(i),glcm_dis(i),glcm_ac(i),...
...
tg_rn=zeros(12,3);
for i=1:12
    tg_rn(i,:)=[g_v(i),g_s(i),g_k(i)];
end
save('tot/tg_rn','tg_rn')
